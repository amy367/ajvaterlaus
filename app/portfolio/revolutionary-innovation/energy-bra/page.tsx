      ...
      <div className="grid sm:grid-cols-2 gap-16 items-start">
        <div className="grid grid-cols-2 gap-3">
          <div className="relative aspect-square overflow-hidden">
            <Image src="/images/product_energy-bra_detail1.png" alt="Energy Apparel — TechFit sports bra" fill className="object-cover" />
          </div>
          <div className="relative aspect-square overflow-hidden">
            <Image src="/images/product_energy-bra_detail2.png" alt="Energy Apparel — TechFit tights" fill className="object-cover" />
          </div>
        </div>
